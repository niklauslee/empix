...
const SvgDelete = ({ size = 24, strokeWidth = 2, ...props }: IconProps) => (
  <svg
  ...
  >
    ...
    <rect x="18" y="9" width="3" height="12" fill="currentColor" />
    ...
    <rect x="3" y="9" width="3" height="12" fill="currentColor" />
